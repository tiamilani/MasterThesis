...
A node wouldn't be considered converged untill it has also solved the suppressed
routes.
...
APNIC\footnote{\href{https://blog.apnic.net/2020/01/15/bgp-in-2019-bgp-churn/}{APNIC BGP 2019 report}}
...
This experiments renforce the hypothesis that a small number of suppressions is
