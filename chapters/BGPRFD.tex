...
We can see two compleatly different evolutions of the performances in \Cref{fig:clique_rfd7196}.
...
Thanks to the studies of APNIC \fxfatal{insert citation of footnode, something}
...
This example is showed in \Cref{fig:ripePrefixFlaps}, it take in consideration the
prefix \q{202.64.49.0/24} show that in a relative small period of time it has
...
In both this environments I have then compared the four different strategy of
...
of those suppressions can be saw in \Cref{fig:1000_RFD_MRAI30_mice_time} because its
...
The effects of those suppressions are visibile in \Cref{fig:1000_RFD_MRAI30_mice_time}
...
We can then study which are the nodes that produces the suppressions and how
...
\fxfatal{I don't really know how to explain the rfd courve in \Cref{fig:1000_2439RFD_multiMRAI_mice}}
