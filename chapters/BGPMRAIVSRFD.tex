...
frequency.
For this experiments I used the same environments described in \Cref{sec:rfd_mice_vs_elephants}.
...
\begin{figure}[h]
     ...
     \end{subfigure}
		...
		strategy fixed, \fxfatal{Adapt y ranges}, each point is the average of
		\num{10} repetitions}
