...
It is possible to notice in \Cref{fig:clique_evolution} both the effect of \ac{MRAI}
and \ac{IW}.
...
In \Cref{fig:clique_evolution_noIW} we can see the same effects but with a higher
\ac{MRAI} value.
...
with a box-plot in \Cref{fig:boxplot_internet_like_1000}.
...
While, in the time required to convergence, \Cref{fig:boxplot_internet_like_1000_time},
...
\begin{figure}[h]
	...
	topology with \num{1000} nodes, \ac{MRAI} generated randomly and adapted to
		...
		\num{10} points.\fxfatal{add $[s]$ to the y axis}}
...
\Cref{fig:different_destinations_mean}.
=======
