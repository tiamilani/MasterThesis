...
more than a big network where interconnected entities keep the prefixes \rlc{non hai definito cos'è un prefisso} reachable.
...
The protocol that has been created \rlc{designed / devised} to handle these situations is  \ac{BGP}.
