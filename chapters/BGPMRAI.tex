...
This is because, after the first \q{A}, by giving a long enough \ac{MRAI} timer,
a node can compress a sequence ending with another \q{A} to the
...
The first and the last cases of \Cref{eq:dpc} are swapped, resulting in a
