...
The reverse of the \ac{DPC} strategy is simply to opposite of it, it is going to
set a higher \ac{MRAI} value for those nodes that are in the first part of the 
propagation graph.
